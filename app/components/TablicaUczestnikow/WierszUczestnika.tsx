...
interface Props {
  ...
  polaDoPokazania?: Array<
    "dubbleSlots" | "monthlySlotsLimit" | "name" | "active" | "status" | "Akcje"
  >;
}
...
export default function WierszUczestnika({
  ...
  const widocznePola = polaDoPokazania ?? [
    "name",
    "status",
    "active",
    "dubbleSlots",
  ...
  const handleUpdate = useCallback(
    ...
    [participant.id, queryClient, ustawUsera]
  );
  ...
  return (
    <tr className="hover">
      ...
      {/* DoubleSlots */}
      {widocznePola?.includes("dubbleSlots") && (
        <td>
      ...
      {/* monthlySlotsLimit */}
      {widocznePola?.includes("monthlySlotsLimit") && (
        <td>
